...
const Products = () => {
  ...
  const [styleCanvas, SetStyleCanvas] = useState(false);
  function createIcon() {
    SetStyleCanvas(styleCanvas => !styleCanvas);
  }
  return (
    <div className="flex justify-center">
      <div>
        ...
        {!styleCanvas && <input
          ...
          onChange={onChange}
        />}
        <button onClick={createIcon}>Create Icon</button>
        {
          styleCanvas &&
          <div>
        ...
        {
          fileUrl && (
            <img className="rounded mt-4" width="350" src={fileUrl} alt={fileUrl} />
          )
        }
